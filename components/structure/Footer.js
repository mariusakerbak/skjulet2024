...
export default function Footer() {
    return (<footer className="container w-full flex-col md:flex-row mx-auto flex justify-items-center min-h-[400px] mt-[100px] bg-black">
    ...
    <article className="flex-auto bg-lion md:rounded-t-lg p-4">
      <Link href={`/`}><Image src="/images/skjulet_logo_hvit.svg" width={300} height={112} alt="Skjulet" /></Link>
      <p>Følg oss:</p>
      <nav className="flex">
